...
// To compile: qmk compile -kb cantor -km evanrichards
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [0] = LAYOUT_split_3x6_3(
        ...
        KC_NO, CTL_T(KC_A), OPT_T(KC_R), CMD_T(KC_S), LSFT_T(KC_T), ALL_T(KC_G),     ALL_T(KC_M), RSFT_T(KC_N), CMD_T(KC_E),OPT_T(KC_I), CTL_T(KC_O), KC_NO,
