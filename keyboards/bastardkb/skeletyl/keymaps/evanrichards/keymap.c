...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [0] = LAYOUT_split_3x5_3(
        ...
        CTL_T(KC_A), OPT_T(KC_R), CMD_T(KC_S), LSFT_T(KC_T), ALL_T(KC_G),     ALL_T(KC_M), RSFT_T(KC_N), CMD_T(KC_E),OPT_T(KC_I), CTL_T(KC_O),
    ...
    [1] = LAYOUT_split_3x5_3(
          KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,                         KC_GRAVE,  KC_7,  KC_8,  KC_9, KC_BSLS, 
        KC_LCTL, KC_LSFT, KC_LALT, KC_LCMD,   KC_NO,                          KC_MINS,  KC_4,  KC_5,  KC_6, KC_QUOT, 
          KC_NO,   KC_NO,   KC_NO,   KC_NO, QK_BOOT,                        S(KC_EQL),  KC_1,  KC_2,  KC_3, KC_SLSH, 
    ...
    [3] = LAYOUT_split_3x5_3(
        S(KC_BSLS), S(KC_9),  S(KC_8),  S(KC_7), S(KC_GRAVE),                  KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,
        S(KC_QUOT), S(KC_6),  S(KC_5),  S(KC_4),  S(KC_MINS),                  KC_NO, KC_LCTL, KC_LSFT, KC_LALT, KC_LCMD,
             KC_NO, S(KC_3),  S(KC_2),  S(KC_1),      KC_EQL,                  KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,
                                                 KC_NO,       KC_NO,  KC_NO,   KC_NO, KC_NO,   KC_NO
    ),
    ...
    [4] = LAYOUT_split_3x5_3(
        KC_NO,      KC_NO, S(KC_LBRC), S(KC_RBRC),     KC_NO,                   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,
        KC_NO,      KC_NO,    S(KC_9),    S(KC_0),     KC_NO,                   KC_NO, KC_LCTL, KC_LSFT, KC_LALT, KC_LCMD,
        KC_NO, S(KC_COMM),    KC_LBRC,    KC_RBRC, S(KC_DOT),                   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,
                                                  KC_NO,      KC_NO,  KC_NO,    KC_NO, KC_NO,     KC_NO
    )
    /*
     * New layers:
